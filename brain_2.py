            ...
            if traffic_light != None:
                ...
                if traffic_light == 'GO' and self.first_park_success == False:
                    if parking_x_1 < 8.50:    
                        ...
                        if self.isinParking(pose_data, parking_x_1, parking_y_1, parking_yaw_1) == True:
                            angle = 0
                            speed = 0
                        ...
                        way_point_3_4 = [(7.84, -14.61), (9.92, -15.44), (12.42, -16.91), (12.65, -18.38)]
                        way_point_3_4.append((parking_x_1, parking_y_1 + 1.5))
                        way_point_3_4.append((parking_x_1, parking_y_1 + 0.5))
                        
                        way_point = way_point_3_4
